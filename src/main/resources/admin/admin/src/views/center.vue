  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='huiyuan'"  label="身份证" prop="shenfenzheng">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='yuangong'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
