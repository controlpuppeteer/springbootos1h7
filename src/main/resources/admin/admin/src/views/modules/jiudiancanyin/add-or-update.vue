<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="餐饮名称" prop="canyinmingcheng">
					<el-input v-model="ruleForm.canyinmingcheng" placeholder="餐饮名称" clearable  :readonly="ro.canyinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="餐饮名称" prop="canyinmingcheng">
					<el-input v-model="ruleForm.canyinmingcheng" placeholder="餐饮名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="餐饮分类" prop="canyinfenlei">
					<el-input v-model="ruleForm.canyinfenlei" placeholder="餐饮分类" clearable  :readonly="ro.canyinfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="餐饮分类" prop="canyinfenlei">
					<el-input v-model="ruleForm.canyinfenlei" placeholder="餐饮分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="餐饮介绍" prop="canyinjieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.canyinjieshao" label="餐饮介绍" prop="canyinjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.canyinjieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.canyinjieshao = this.ruleForm.canyinjieshao.replace(reg,'../../../springbootos1h7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
