	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="客房状态" prop="kefangzhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="客房状态" prop="kefangzhuangtai">
