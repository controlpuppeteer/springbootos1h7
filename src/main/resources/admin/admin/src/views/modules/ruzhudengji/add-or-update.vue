<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="入住编号" prop="ruzhubianhao">
					<el-input v-model="ruleForm.ruzhubianhao" placeholder="入住编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.ruzhubianhao" label="入住编号" prop="ruzhubianhao">
					<el-input v-model="ruleForm.ruzhubianhao" placeholder="入住编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="入住备注" prop="ruzhubeizhu">
					<el-input v-model="ruleForm.ruzhubeizhu" placeholder="入住备注" clearable  :readonly="ro.ruzhubeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="入住备注" prop="ruzhubeizhu">
					<el-input v-model="ruleForm.ruzhubeizhu" placeholder="入住备注" readonly></el-input>
				</el-form-item>
