...
public interface HuiyuanService extends IService<HuiyuanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<HuiyuanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<HuiyuanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<HuiyuanEntity> wrapper);
