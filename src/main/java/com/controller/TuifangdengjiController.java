...
public class TuifangdengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,TuifangdengjiEntity tuifangdengji,
		...
		if(tableName.equals("huiyuan")) {
			tuifangdengji.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yuangong")) {
			tuifangdengji.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
